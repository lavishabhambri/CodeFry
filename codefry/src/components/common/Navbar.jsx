        ...
        return (
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                ...
                <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <a className="navbar-brand text-white" href="#"><span><strong style={{color:"#5BC0DE", fontSize:"22px"}}>Codefry&nbsp;<i className="fas fa-code"></i></strong></span></a>
                    ...
                    <li>
                    <button type="button" className="btn btn-info" id="navbar-button" ><span style={{color:"#000"}}>Login</span></button>
                    </li>
                    </ul>
                </div>
            </nav>
